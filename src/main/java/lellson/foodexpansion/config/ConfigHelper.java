...
public final class ConfigHelper {
    ...
    public static void bakeCommon(final ModConfig config) {
        ...
        //1.18.1
        FoodExpansionConfig.disableGoatMeatDrop = ConfigHolder.COMMON.disableGoatMeatDrop.get();
        FoodExpansionConfig.disableGlowSquidDrop = ConfigHolder.COMMON.disableGlowSquidDrop.get();
        FoodExpansionConfig.disableRecipeCookedGoatMeat = ConfigHolder.COMMON.disableRecipeCookedGoatMeat.get();
        FoodExpansionConfig.disableRecipeCookedGlowSquid = ConfigHolder.COMMON.disableRecipeCookedGlowSquid.get();
