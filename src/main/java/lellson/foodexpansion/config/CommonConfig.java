...
final class CommonConfig {
    ...
    //1.18.1
    final ForgeConfigSpec.BooleanValue disableGoatMeatDrop;
    final ForgeConfigSpec.BooleanValue disableGlowSquidDrop;
    final ForgeConfigSpec.BooleanValue disableRecipeCookedGoatMeat;
    final ForgeConfigSpec.BooleanValue disableRecipeCookedGlowSquid;
    ...
    private static final String DISABLERECIPE_CookedGoatMeat = "Disable Cooked Goat Meat Smelting Recipe";
    private static final String DISABLERECIPE_CookedGlowSquid = "Disable Cooked Glow Squid Smelting Recipe";
    ...
    private static final String DISABLEDROP_GoatMeatDrop = "If set to true, polar bears are not allowed to drop Goat Meat";
    private static final String DISABLEDROP_GlowSquidDrop = "If set to true, polar bears are not allowed to drop Glow Squid Meat";
    ...
    CommonConfig(final ForgeConfigSpec.Builder builder) {
        ...
        disableRecipeCookedGlowSquid = builder
                .comment(DISABLERECIPE_CookedGlowSquid)
                .define("disableRecipeCookedGlowSquid", false);
        
        disableRecipeCookedGoatMeat = builder
                .comment(DISABLERECIPE_CookedGoatMeat)
                .define("disableRecipeCookedGoatMeat", false);
        ...
        disableGoatMeatDrop = builder
                .comment(DISABLEDROP_GoatMeatDrop)
                .define("disableGoatMeatDrop", false);
