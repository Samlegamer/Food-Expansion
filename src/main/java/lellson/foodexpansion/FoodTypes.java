...
public class FoodTypes
{
    ...
    //1.18.1 (Add by Samlegamer)
    public static final FoodProperties GLOW_SQUID = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.2F).effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 30, 0), 0.5F).build();;
    public static final FoodProperties GLOW_COOKED_SQUID = (new FoodProperties.Builder()).nutrition(3).saturationMod(0.5F).effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 250, 0), 1.0F).build();;
    public static final FoodProperties GOAT_MEAT = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.9F).meat().build();
    public static final FoodProperties COOKED_GOAT_MEAT = (new FoodProperties.Builder()).nutrition(8).saturationMod(1.6F).meat().build();
